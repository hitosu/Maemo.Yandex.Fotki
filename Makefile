...
ACLOCAL = ${SHELL} /home/hitosu/workspace/yandex-fotki-sharing-plugin/missing --run aclocal-1.8
AMDEP_FALSE = #
AMDEP_TRUE = 
...
AUTOMAKE = ${SHELL} /home/hitosu/workspace/yandex-fotki-sharing-plugin/missing --run automake-1.8
AWK = gawk
CC = gcc
...
install_sh = /home/hitosu/workspace/yandex-fotki-sharing-plugin/install-sh
